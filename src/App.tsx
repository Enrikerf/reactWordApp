...
import { searchOutline, folderOutline, barbellOutline } from "ionicons/icons";
...
import EntryDetailPage from "./pages/HomeworkPage/pages/EntryDetailPage";
    ...
    <IonReactRouter>
      <IonTabs>
        <IonRouterOutlet>
          ...
          <Route path="/entryDetail" component={EntryDetailPage} />
          <Route
            path="/"
            render={() => <Redirect to="/tabHomework" />}
            exact={true}
          />
        </IonRouterOutlet>
